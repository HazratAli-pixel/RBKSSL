...
if(strlen($_SESSION['alogin'])==0)
	...
	{
		$did=$_GET['del'];
		$sql = "delete from admin WHERE  UserId=:did";
		$query = $dbh->prepare($sql);
		$query-> bindParam(':did',$did, PDO::PARAM_STR);
		$query -> execute();

		$sql2 = "delete from user_info WHERE  UserId=:did2";
		$query2 = $dbh->prepare($sql2);
		$query2-> bindParam(':did2',$did, PDO::PARAM_STR);
		$query2 -> execute();
...
<head>
	...
	<title>Dshop-System User List</title>
								...
								<div class="col-12 table-responsive">
									<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
										...
										<tbody>
											...
											<?php $sql = "SELECT user_info.ID, user_info.Name, user_info.UserId, user_info.NidNumber, user_info.FName,user_info.MName, user_info.Phone1, 
											user_info.Phone2, user_info.Email1,user_info.Address, user_info.Photo, user_info.Date, user_info.Status, admin.Position FROM user_info 
											LEFT JOIN admin ON user_info.UserId = admin.UserId";
											$query = $dbh -> prepare($sql);
											$query->execute();
											...
											?></td>
												...
												<td>
													<a href="#?edit=<?php echo htmlentities($result->ID);?>" > <i class="fas fa-edit" aria-hidden="true"></i></a> 
													<a href="#" > <i class="fas fa-eye" aria-hidden="true"></i></a> 
													<a href="user_list.php?del=<?php echo htmlentities($result->UserId);?>" onclick="return confirm('Do you really want to delete this record')"> <i style="color: red;" class="far fa-trash-alt" aria-hidden="true"></i></a>
												</td>
											</tr>
											<?php $cnt=$cnt+1; }} ?>
										</tbody>
