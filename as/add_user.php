							...
							<div class="card">
								<div class="card-header d-flex justify-content-between align-items-center h-100px">
											...
											<div >
												...
												<a href="set-rule.php"><button type="button" class="btn btn-info"><i class="fas fa-pencil mr-2" style="margin-right: 10px;"></i> Assign Rule</button></a>
											</div>
								</div>
								<div class="card-body">
