									...
									<div class="col-12 col-md-8 col-lg-8 col-xl-9 d-flex row flex-sm-column table-responsive">
										...
										<table id="zctb" class="display table table-striped table-bordered table-hover" >
											...
											<tbody>
												...
												<?php 
												$sql = "SELECT company.name as cname, companyinvoice.ID, companyinvoice.InvoiceId , companyinvoice.Subtotal, companyinvoice.Vat, companyinvoice.Discount, companyinvoice.G_total,companyinvoice.Paid,companyinvoice.DueAmount, companyinvoice.Date,companyinvoice.Status FROM companyinvoice left JOIN company ON company.ID = companyinvoice.CompanyId ORDER BY companyinvoice.ID DESC";
												$query = $dbh -> prepare($sql);
												$query->execute();
