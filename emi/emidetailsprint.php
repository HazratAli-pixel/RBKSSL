...
if($query->rowCount() > 0){
	foreach($results as $result){
		...
		<tr>
			...
			<td colspan="1" align="right">'."$result->InvoiceId".'</td>
			<td colspan="1" align="right">'."$result->Qty".'</td>
			<td colspan="2" align="right">'."$result->Price".'</td>
...
<table border="1" cellspacing="none" cellpadding="4">
	<tr>
		...
		<th bgcolor="#cccccc" style="font-weight: bold;" colspan="1" align="right">Invo NO</th>
